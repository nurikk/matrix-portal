...
volatile bool gReqFill = false;          // Single-color fill deferred action, consumed by loop() on core 1
volatile bool gReqFillRandom = false;    // Random-color fill deferred action, consumed by loop() on core 1
